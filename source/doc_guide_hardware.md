...
## Physical map
The position pointed by the arrow is the pin of **Pin1**
![](./media/PIN.png)


## Related drawings
The hardware drawings can be downloaded through [Baidu Netdisk (extraction code: Zero)](https://pan.baidu.com/s/1ZhK5TAt4H6BPRn4bDA1oXA). <br />
